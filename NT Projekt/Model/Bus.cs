...
namespace NT_Projekt.Model {
    public class Bus {
        ...
        public Bus(string brand, string model, string licensePlate, double energyUsage, string energyType) {
            this._brand = brand;
            this._model = model;
        ...
        public override string ToString() {
            return $"{Brand};{Model};{LicensePlate};{EnergyUsage};{EnergyType}";
        }
        ...
        public static Bus FromString(string line) {
            ...
            double energyUsage = double.Parse(parts[3]);
            string energyType = parts[4];

            Bus bus = new Bus(brand, model, licensePlate, energyUsage, energyType);
